...
Officer: 6576922
CaseNum: 502-0-49813810-6576922
...
var ArchiveA = ["Torvalds", "Cobol Theatre", "Algol Fish Wholesalers", "supply of fish", "affair"];

var ArchiveB = ["Judge Hopper", "Lovelace", "Edsger", "clean up", "Governor Zuckerberg"];
...
function setup()
{
  ...
  redactedText = "Dear "+ArchiveB[4]+", I am writing to you with much confusion and distress. As you know my company "+ArchiveA[2]+" has been a bastion of the community. Over the years we have provided many jobs for the people of Console City. We’ve kept the city in a good "+ArchiveA[3]+". We even paid some tax once. Now I find that our efforts to open a new plant opposite the "+ArchiveA[1]+" is being blocked by your very own "+ArchiveB[0]+". Did I not help you "+ArchiveB[3]+" the mess after "+ArchiveA[0]+" ? Did I not keep quiet about your "+ArchiveA[4]+" with "+ArchiveB[1]+"? Contact me discreetly and with haste. Some arrangement must be found. Your old friend, "+ArchiveB[2]+"";
