...
Officer: 6576922
CaseNum: 701-0-78327094-6576922
...
They’ve managed to collect a witness statement from an unsuspecting tourist jaunita niemela and also rounded up a bunch of the usual suspects.
...
It was last Thursday, I heard noises outside so I looked out and saw a person in the steet. I'm not quite sure. 
They were carrying a glass bottle. It's so hard to remember right now. I'll never forget their black eyes. 
Their expression seemed depressed. That's all I know officer. 
...
function matchSuspectProperties(suspectObj)
{
	if(suspectObj.eyes == "black" && suspectObj.accessory == "glass bottle" && suspectObj.expression == "depressed")
		{
			return true;
		}
	return false;
