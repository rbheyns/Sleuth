...
Officer: 6576922
CaseNum: 402-3-44200244-6576922

This final Why gang member Fox is the boss of the gang. 
Fox is particularly cunning and has hidden herself down this twisted network of alleys known as vice city.
...
function draw()
{
	...
	///////////////////ADD YOUR CODE HERE///////////////////
// south
if (det.locationX > 750 && det.locationY < 135)
{
	det.speedX = 0;
	det.speedY = 1;
}
// west
else if (det.locationX > 381 && det.locationY <= 135)
{
	det.speedX = -1;
	det.speedY = 0;
}
// south
else if (det.locationX <= 381 && det.locationY < 195)
{
	det.speedX = 0;
	det.speedY = 1;
}
// east
else if (det.locationY >= 195 && det.locationX < 700 && det.locationY < 300)
{
	det.speedX = 1;
	det.speedY = 0;
}
// south
else if (det.locationX >= 701 && det.locationY < 320)
{
	det.speedX = 0;
	det.speedY = 1;
}
// west
else if (det.locationY >= 320 && det.locationX >= 200 && det.locationY < 400)
{
	det.speedX = -1;
	det.speedY = 0;
}
// south
else if (det.locationX <= 200 && det.locationY < 440)
{
	det.speedX = 0;
	det.speedY = 1;
}
// east
else if (det.locationY >= 440 && det.locationX < 575 && det.locationY < 500)
{
	det.speedX = 1;
	det.speedY = 0;
}
// south
else if (det.locationX >= 575 && det.locationY < 565)
{
	det.speedX = 0;
	det.speedY = 1;
}
// west
else if (det.locationY >= 565 && det.locationX > 260 && det.locationY < 600)
{
	det.speedX = -1;
	det.speedY = 0;
}
// south
else if (det.locationX <= 260 && det.locationY < 625)
{
	det.speedX = 0;
	det.speedY = 1;
}
// east
else if (det.locationY >= 625 && det.locationX < 700 && det.locationY < 695)
{
	det.speedX = 1;
	det.speedY = 0;
}
// south
else if (det.locationX >= 700 && det.locationY < 695)
{
	det.speedX = 0;
	det.speedY = 1;
}
